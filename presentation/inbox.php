...
?>
        <li class="nav-item mb-2">
            <a class="nav-link bg-orange text-white" href="inbox.php">
  ...
  <div class="flex-grow-1" style="background: linear-gradient(135deg, #fff5f0 0%, #ffe8d9 100%); padding: 20px;min-height: 100vh;">

    <div class="container">
        <div class="header">
            <h2>Inbox <?php if ($unreadCount > 0): ?><span class="badge"><?php echo $unreadCount; ?> unread</span><?php endif; ?></h2>
            <div>
                <a href="send_message.php"><button>Compose</button></a>
                <a href="sent_messages.php" style="margin-left: 10px;">Sent Messages</a>
            </div>
        </div>
            ...
            <?php else: ?>
                <?php foreach ($messages as $message): ?>
                    <a href="view_message.php?id=<?php echo $message['messageId']; ?>" style="text-decoration: none; color: inherit;">
                        <div class="message-item <?php echo !$message['isRead'] ? 'unread' : ''; ?>">
                            ...
                            <div class="message-time">
                                ...
                                <?php if (!$message['isRead']): ?><span style="color: #4F46E5;">●</span><?php endif; ?>
                            </div>
                        </div>
                    </a>
                <?php endforeach; ?>
